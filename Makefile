...
retrieve: 
	curl -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJERVZFTE9QTUVOVCBLRVkiLCJuYW1lIjoiRXdhbiBHcmVlciIsImlhdCI6MTUxNjIzOTAyMiwiZXhwIjoyNTQxMTYxNTExfQ.2xpRU9rmIoNpk9syA_6Bgc3Alrbu3tp4Xm0-s-MymTs" \
		--request GET \
		http://localhost:3000/api/$(COMMID)
